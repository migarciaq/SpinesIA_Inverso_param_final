...
%  INTER-COLUMN ARROWS
% ============================================================
\def\arrowH{0.5}  % arrow height
\def\arrowTip{0.35} % triangle tip length
...
% =============================================
%  3 SPIN LATTICE GRIDS (bigger, centered)
% =============================================
\def\gridStep{0.32}
\def\arrowLen{0.14}
 
% --- Grid 1 (random/hot state) ---
...
% Dots between grid 1 and grid 2
...
\begin{scope}
  ...
  \node[inner sep=0pt] at ({\cw/2}, 7.85) {
...
% Arrow down
\draw[-{Stealth[length=20mm, width=20mm]}, darktext!70, thick] 
  ({\cw/2}, 6.75) -- ({\cw/2}, 6.35);
...
% =============================================
% =============================================
% Shared 3D offset for depth illusion
\def\dX{0.5}  % depth x-shift
\def\dY{0.4}  % depth y-shift
\def\pW{0.2}  % layer width (wider = more block-like)
\def\pGap{0.15} % gap between layers
...
\node[inner sep=0pt] at ({\cw/2 - 0.4}, 1.8) {
...
\node[inner sep=0pt] at ({\cw/2 - 0}, 1.2) {
