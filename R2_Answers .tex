...
\label{tab:litcomp_resp}
\setlength{\tabcolsep}{4pt}
\resizebox{\textwidth}{!}{%
\begin{tabular}{@{}p{2.2cm} p{2.6cm} p{2.6cm} p{2.6cm} p{3.4cm}@{}}
\toprule
\textbf{\footnotesize Dimension} & \textbf{\footnotesize Kong~\cite{kong2023quantifying}} & \textbf{\footnotesize Kwon~\cite{kwon2020magnetic}} & \textbf{\footnotesize Lee~\cite{lee2024deep}} & \textbf{\footnotesize Ours} \\
\midrule
\textbf{\footnotesize Hamiltonian terms}
& \footnotesize Exchange $A$, aniso.\ $K_\text{eff}$, DMI $D$
& \footnotesize Exchange $J$, DMI $\beta$, dipolar $D$, aniso.\ $K$
& \footnotesize Intralayer $J$, single-ion $A$, interlayer $J^{\perp}$
& \footnotesize Ext.\ Heisenberg $\tilde{J}_1$--$\tilde{J}_4$, $\tilde{K}_{DM}$, $\tilde{H}_{ex}$, $\tilde{K}_{an1}$, $\tilde{K}_{anS}$ \\
\midrule
\textbf{\footnotesize Simulation}
& \footnotesize Micromagnetic (mumax3, LLG)
& \footnotesize MC simulated annealing
& \footnotesize Atomistic (stochastic LLG)
& \footnotesize Atomistic MC (Metropolis + annealing, multi-GPU) \\
\midrule
\textbf{\footnotesize DL architecture}
& \footnotesize Custom CNN
& \footnotesize ResNet18/50, CNN
& \footnotesize MLPs
& \footnotesize CNN baseline + DenseNet, ViT, Xception, ResNet \\
\midrule
\textbf{\footnotesize Params.\ estimated}
& \footnotesize 4
& \footnotesize 3
& \footnotesize 3
& \footnotesize 8 \\
\midrule
\textbf{\footnotesize Metrics}
& \footnotesize MAE, $R^2$
& \footnotesize MAE, PCA of errors
& \footnotesize MAPE, MSE
& \footnotesize $R^2$, MAE + UMAP/HDBSCAN clustering \\
\midrule
\textbf{\footnotesize Interpret.}
& \footnotesize Feature maps (black box)
& \footnotesize Black box
& \footnotesize Black box (PCA)
& \footnotesize \textbf{RAMs} (layer/structure) + identifiability \\
\bottomrule
\end{tabular}%
}
\end{table}}
