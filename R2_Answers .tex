...
\reply{Agradezco su comentario. Por la simetría, no consideramos conveniente la simulación de DMI en los valores negativos. Justificar con estado del arte publicado en los últimos 4 años como máximo. Nota: en el experimental setup o metodos, cuando se describen los rangos de los parametros se debe aclarar esto}
